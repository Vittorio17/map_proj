...
public class Data {
	...
	/**
     * Costruisce il dataset caricando lo schema e le tuple dalla tabella specificata.
     * 
     * @param tableName Il nome della tabella presente nel database.
     * @throws TrainingDataException Se si verificano anomalie strutturali o problemi di accesso al database.
     */
	...
	*/
	 ...
	 * @return L'oggetto Attribute indicizzato.
	 */
	 ...
	 * @return L'oggetto ContinuousAttribute associato al valore target.
	 */
