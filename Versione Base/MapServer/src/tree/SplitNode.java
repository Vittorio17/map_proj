...
abstract class SplitNode extends Node implements Comparable<SplitNode>{
	...
	class SplitInfo implements Serializable{
		...
		/**
		 * Restituisce l'indice iniziale del sottoinsieme di esempi coperto dal nodo.
		 * @return L'indice iniziale nell'array del dataset.
		 */
        int getBeginindex(){
			return beginIndex;			
		}
        ...
        /**
		 * Restituisce l'indice finale del sottoinsieme di esempi coperto dal nodo.
		 * @return L'indice finale nell'array del dataset.
		 */
		int getEndIndex(){
			return endIndex;
		}
